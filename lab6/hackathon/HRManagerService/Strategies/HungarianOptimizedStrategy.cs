...
public class HungarianOptimizedStrategy : ITeamBuildingStrategy
{
        ...
        IEnumerable<Wishlist> juniorsWishlists)
    {
        ...
        var teamLeadPrefDict = teamLeadsWishlists.ToDictionary(w => w.ParticipantId, w => w.DesiredParticipants);
        var juniorPrefDict = juniorsWishlists.ToDictionary(w => w.ParticipantId, w => w.DesiredParticipants);
    ...
    private double ComputeHarmonicMean(
        int[] match,
        List<Participant> teamLeadsList,
        List<Participant> juniorsList,
