...
public class TeamleadBackgroundService : BackgroundService
{
    private readonly ILogger<TeamleadBackgroundService> _logger;
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly ServiceSettings _serviceSettings;
    private readonly DataLoader _dataLoader;

    public TeamleadBackgroundService(
        ILogger<TeamleadBackgroundService> logger,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation("Teamlead '{Id} {Name}' is sending data...", _serviceSettings.Participant.Id, _serviceSettings.Participant.Name);
        ...
        _logger.LogInformation("Teamlead '{Id} {Name}' has sent their data.", _serviceSettings.Participant.Id, _serviceSettings.Participant.Name);
        ...
        _logger.LogInformation("Teamlead '{Id} {Name}' has sent their wishlist.", _serviceSettings.Participant.Id, _serviceSettings.Participant.Name);
    }
