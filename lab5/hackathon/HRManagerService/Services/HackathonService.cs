...
//             {
//                 logger.LogWarning("Недостаточно участников для создания хакатона.");
//                 return;
//             }
//             
...
//
//             logger.LogWarning("Хакатон {HackathonId} создан и данные отправлены в HRDirectorService.", hackathon.Id);
//         }
//     }
// }
